...
namespace AspNetCoreWebApi.Models.db1
{
    public partial class m_db1Context : DbContext
    {
        ...
        public virtual DbSet<m_tmp_t_without_increment> m_tmp_t_without_increments { get; set; } = null!;
        public virtual DbSet<m_tmp_t_without_increment_3> m_tmp_t_without_increment_3s { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<m_tmp_t_without_increment>(entity =>
            {
                entity.ToTable("m_tmp_t_without_increment");

                entity.Property(e => e.id).ValueGeneratedNever();
            });

            modelBuilder.Entity<m_tmp_t_without_increment_3>(entity =>
            {
                entity.HasKey(e => e.m_id);

                entity.ToTable("m_tmp_t_without_increment_3");
